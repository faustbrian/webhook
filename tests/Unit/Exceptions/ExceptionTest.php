...
describe('InvalidEd25519PrivateKeyException', function (): void {
    ...
    describe('Edge Cases', function (): void {
        test('can be caught and re-thrown', function (): void {
            ...
            } catch (InvalidEd25519PrivateKeyException $invalidEd25519PrivateKeyException) {
                $caught = true;
                expect($invalidEd25519PrivateKeyException->getMessage())->toBe('Invalid Ed25519 private key format');
            }
